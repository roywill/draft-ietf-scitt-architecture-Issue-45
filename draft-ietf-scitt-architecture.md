...
: an entity that can review entries of a Transparency Service's Append-only Log content to validate the application and enforcment of Registration Policy for each transaction.
